    ...
    <div className="my-6 font-[sans-serif] mt-20">
      ...
      <div className="grid md:grid-cols-3 gap-6 max-w-6xl mx-auto">
        <div className="max-w-[350px] h-auto sm:p-8 p-4 rounded-md mx-auto shadow-[0_2px_22px_-4px_rgba(93,96,127,0.2)] bg-white relative">
          ...
          Homaloid Technologies has been a game-changer for our business.
            ...
            Homaloid to any company looking to future-proof their technology.
          </p>
        ...
        <div className="max-w-[350px] h-auto sm:p-8 p-4 rounded-md mx-auto shadow-[0_2px_22px_-4px_rgba(93,96,127,0.2)] bg-white relative">
          <p className="text-sm text-center text-[#333] leading-relaxed">
            ...
            keep up with our evolving needs. Homaloid Technologies exceeded our
        ...
        <div className="max-w-[350px] h-auto sm:p-8 p-4 rounded-md mx-auto shadow-[0_2px_22px_-4px_rgba(93,96,127,0.2)] bg-white relative">
          <p className="text-sm text-center text-[#333] leading-relaxed">
            Homaloid Technologies has been an indispensable partner in our
